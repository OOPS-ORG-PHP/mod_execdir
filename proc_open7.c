...
#if PHP_VERSION_ID >= 70000 && PHP_VERSION_ID < 70400
...
/* {{{ proto resource proc_open_re(string command, array descriptorspec, array &pipes [, string cwd [, array env [, array other_options]]])
...
#endif /* PHP_VERSION_ID >= 70000 && PHP_VERSION_ID < 70400 */
